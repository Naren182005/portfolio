...
import imgMan from '../assets/man/naren_profile.jpg';
...
export default function About() {
  ...
  const handleMouseLeave = () => {
    // Return to default center position smoothly and reset mask size
    gsap.to(maskRef.current, {
      '--x': '50%',
      '--y': '50%',
      '--radius': '0%',
  ...
  const handleMouseEnter = () => {
    // Expand mask to perfectly show the image on hover
    gsap.to(maskRef.current, {
      '--radius': '150%',
      duration: 0.8,
      ease: 'power2.out'
    ...
    >
      ...
      <div className="max-w-[90rem] w-full grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center relative z-10">
        ...
        <div 
          ...
          className="relative w-[75%] aspect-[4/5] max-w-[260px] sm:max-w-sm md:w-full md:max-w-md mx-auto lg:max-w-none rounded-2xl overflow-hidden cursor-crosshair group shadow-2xl border border-white/5 bg-black"
        ...
        >
          ...
          {/* Masked Overlay: Developer Persona (Vibrant) */}
          <div 
            ref={maskRef}
          ...
          >
            <img 
              ...
              className="absolute inset-0 w-full h-full object-contain object-center scale-105 group-hover:scale-110 transition-transform duration-[2s] ease-out"
            />
        ...
        <div ref={textContainerRef} className="flex flex-col justify-center space-y-10">
          ...
          <div className="overflow-hidden">
            <h2 className="stagger-reveal text-5xl md:text-6xl font-bold tracking-tighter text-white font-sans leading-tight">
              Beyond <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-purple-500 font-serif italic pr-4">Models</span>
            </h2>
          </div>

          <div className="overflow-hidden">
            <p className="stagger-reveal text-lg md:text-xl text-gray-400 font-light leading-relaxed max-w-xl">
              Artificial intelligence is more than training models—it's about creating systems that can understand, adapt, and deliver value. I specialize in building agentic AI solutions, scalable ML pipelines, and production-ready architectures designed for real-world challenges.
            </p>
          </div>
